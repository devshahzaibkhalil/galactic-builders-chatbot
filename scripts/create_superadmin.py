...
from app.extensions import build_engine, build_session_factory, create_all, ensure_schema  # noqa: E402
...
def main() -> None:
    ...
    engine = build_engine(config.DATABASE_URL, config.DB_SCHEMA)
    ensure_schema(engine, config.DB_SCHEMA)
